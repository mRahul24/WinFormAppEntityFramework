...
namespace WinFormAppEntityFramework.GUI
{
    public partial class EFTestForm : Form
    {
        ...
        private void buttonUpdate_Click(object sender, EventArgs e)
        {
            ...
            if (emp != null)
            {
                emp.FirstName = "Jennifer";
                emp.LastName = "Nguyen";
                emp.PhoneNumber = "514-123-1234";
                emp.Email = "jennifer@yahoo.ca";
                dbEntities.SaveChanges(); // Update this employee in the database
            ...
            else
            {
                ...
                MessageBox.Show("Employee not found!", "Confirmation");
                return;
            }
        }
